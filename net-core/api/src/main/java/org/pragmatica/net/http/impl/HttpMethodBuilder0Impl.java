...
/// Implementation of HttpMethodBuilder0 for HTTP methods with no path variables and no body
public record HttpMethodBuilder0Impl(HttpClient client, String baseUrl, List<String> pathSegments,
    ...
    public <R> HttpFunction.HttpResponseContentTypeBuilder0<R> get(Class<R> responseType) {
        return new HttpResponseContentTypeBuilder0Impl<>(client, baseUrl, pathSegments, urlBuilder, requestContentType, HttpMethod.GET, responseType);
    }
    ...
    public <R> HttpFunction.HttpResponseContentTypeBuilder0<R> delete(Class<R> responseType) {
        return new HttpResponseContentTypeBuilder0Impl<>(client, baseUrl, pathSegments, urlBuilder, requestContentType, HttpMethod.DELETE, responseType);
    }
