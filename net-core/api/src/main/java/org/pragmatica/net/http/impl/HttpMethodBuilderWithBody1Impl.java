...
/// Stub implementation for HttpMethodBuilderWithBody1
public record HttpMethodBuilderWithBody1Impl<T1, B>(
    HttpClient client, String baseUrl, List<String> pathSegments, UrlBuilder urlBuilder, 
    HttpClientConfig config, ContentType requestContentType, TypeToken<T1> pathVar1Type, TypeToken<B> bodyType
