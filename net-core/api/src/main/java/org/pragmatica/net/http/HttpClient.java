...
/// This is the primary interface providing clean separation between API definition and implementation.
/// 
/// The Function-style DSL is the recommended approach as it provides:
/// - Type-safe parameter handling
/// - Reusable endpoint definitions  
/// - Support for both one-shot and repeated calls
/// - Clean composition and testing
///
/// Example usage:
/// {@code
/// // Reusable function
...
public interface HttpClient {
    ...
    static HttpClient create(HttpClientConfig config) {
        // This will be loaded from the classpath - concrete implementations are provided by specific modules
        try {
