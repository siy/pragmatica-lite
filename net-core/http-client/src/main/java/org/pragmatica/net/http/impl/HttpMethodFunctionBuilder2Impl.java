...
/// Implementation of HttpMethodFunctionBuilder2 for functions with two path variables
public record HttpMethodFunctionBuilder2Impl<T1, T2>(HttpClient client, String baseUrl, List<String> pathSegments,
                                                     List<Class<?>> paramTypes, UrlBuilder urlBuilder, String contentType)
    implements HttpFunction.HttpMethodFunctionBuilder2<T1, T2> {
    
    public HttpMethodFunctionBuilder2Impl {
