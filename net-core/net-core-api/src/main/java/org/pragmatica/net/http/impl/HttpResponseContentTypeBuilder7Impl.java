...
/// Implementation of HttpResponseContentTypeBuilder7 for seven path variables
public record HttpResponseContentTypeBuilder7Impl<T1, T2, T3, T4, T5, T6, T7, R>(HttpClient client, String baseUrl, List<String> pathSegments,
                                                                                 List<Class<?>> paramTypes, UrlBuilder urlBuilder, 
                                                                                 String requestContentType, HttpMethod httpMethod, 
                                                                                 Object responseTypeInfo)
    implements HttpFunction.HttpResponseContentTypeBuilder7<T1, T2, T3, T4, T5, T6, T7, R> {

    public HttpResponseContentTypeBuilder7Impl {
    ...
    public HttpResponseContentTypeBuilder7Impl(HttpClient client, String baseUrl, List<String> pathSegments,
    ...
    @Override
    public Fn7<Promise<R>, T1, T2, T3, T4, T5, T6, T7> as(ContentType responseContentType) {
        return (param1, param2, param3, param4, param5, param6, param7) -> {
            ...
            var url = buildUrlWithParams(List.of(param1, param2, param3, param4, param5, param6, param7));
