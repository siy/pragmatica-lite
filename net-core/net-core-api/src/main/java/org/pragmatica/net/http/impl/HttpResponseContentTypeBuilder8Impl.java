...
/// Implementation of HttpResponseContentTypeBuilder8 for eight path variables
public record HttpResponseContentTypeBuilder8Impl<T1, T2, T3, T4, T5, T6, T7, T8, R>(HttpClient client, String baseUrl, List<String> pathSegments,
                                                                                     List<Class<?>> paramTypes, UrlBuilder urlBuilder, 
                                                                                     String requestContentType, HttpMethod httpMethod, 
                                                                                     Object responseTypeInfo)
    implements HttpFunction.HttpResponseContentTypeBuilder8<T1, T2, T3, T4, T5, T6, T7, T8, R> {

    public HttpResponseContentTypeBuilder8Impl {
    ...
    public HttpResponseContentTypeBuilder8Impl(HttpClient client, String baseUrl, List<String> pathSegments,
    ...
    @Override
    public Fn8<Promise<R>, T1, T2, T3, T4, T5, T6, T7, T8> as(ContentType responseContentType) {
        return (param1, param2, param3, param4, param5, param6, param7, param8) -> {
            ...
            var url = buildUrlWithParams(List.of(param1, param2, param3, param4, param5, param6, param7, param8));
