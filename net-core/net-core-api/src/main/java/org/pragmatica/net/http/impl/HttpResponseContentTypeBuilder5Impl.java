...
/// Implementation of HttpResponseContentTypeBuilder5 for five path variables
public record HttpResponseContentTypeBuilder5Impl<T1, T2, T3, T4, T5, R>(HttpClient client, String baseUrl, List<String> pathSegments,
                                                                         List<Class<?>> paramTypes, UrlBuilder urlBuilder, 
                                                                         String requestContentType, HttpMethod httpMethod, 
                                                                         Object responseTypeInfo)
    implements HttpFunction.HttpResponseContentTypeBuilder5<T1, T2, T3, T4, T5, R> {

    public HttpResponseContentTypeBuilder5Impl {
    ...
    public HttpResponseContentTypeBuilder5Impl(HttpClient client, String baseUrl, List<String> pathSegments,
    ...
    @Override
    public Fn5<Promise<R>, T1, T2, T3, T4, T5> as(ContentType responseContentType) {
        return (param1, param2, param3, param4, param5) -> {
            ...
            var url = buildUrlWithParams(List.of(param1, param2, param3, param4, param5));
