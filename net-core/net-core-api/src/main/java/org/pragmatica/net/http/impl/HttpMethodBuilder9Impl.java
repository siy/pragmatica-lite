...
/// Implementation of HttpMethodBuilder9 for HTTP methods with nine path variables and no body
public record HttpMethodBuilder9Impl<T1, T2, T3, T4, T5, T6, T7, T8, T9>(HttpClient client, String baseUrl, List<String> pathSegments,
                                                                         List<Class<?>> paramTypes, UrlBuilder urlBuilder, ContentType requestContentType)
    implements HttpFunction.HttpMethodBuilder9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    ...
    @Override
    public HttpFunction.HttpResponseContentTypeBuilder9<T1, T2, T3, T4, T5, T6, T7, T8, T9, Unit> get() {
    ...
    @Override
    public HttpFunction.HttpResponseContentTypeBuilder9<T1, T2, T3, T4, T5, T6, T7, T8, T9, Unit> delete() {
