...
/// Implementation of HttpResponseContentTypeBuilder6 for six path variables
public record HttpResponseContentTypeBuilder6Impl<T1, T2, T3, T4, T5, T6, R>(HttpClient client, String baseUrl, List<String> pathSegments,
                                                                             List<Class<?>> paramTypes, UrlBuilder urlBuilder, 
                                                                             String requestContentType, HttpMethod httpMethod, 
                                                                             Object responseTypeInfo)
    implements HttpFunction.HttpResponseContentTypeBuilder6<T1, T2, T3, T4, T5, T6, R> {

    public HttpResponseContentTypeBuilder6Impl {
    ...
    public HttpResponseContentTypeBuilder6Impl(HttpClient client, String baseUrl, List<String> pathSegments,
    ...
    @Override
    public Fn6<Promise<R>, T1, T2, T3, T4, T5, T6> as(ContentType responseContentType) {
        return (param1, param2, param3, param4, param5, param6) -> {
            ...
            var url = buildUrlWithParams(List.of(param1, param2, param3, param4, param5, param6));
