...
/// Implementation of HttpMethodBuilder6 for HTTP methods with six path variables and no body
public record HttpMethodBuilder6Impl<T1, T2, T3, T4, T5, T6>(HttpClient client, String baseUrl, List<String> pathSegments,
                                                             List<Class<?>> paramTypes, UrlBuilder urlBuilder, ContentType requestContentType)
    implements HttpFunction.HttpMethodBuilder6<T1, T2, T3, T4, T5, T6> {
    ...
    @Override
    public HttpFunction.HttpResponseContentTypeBuilder6<T1, T2, T3, T4, T5, T6, Unit> get() {
    ...
    @Override
    public HttpFunction.HttpResponseContentTypeBuilder6<T1, T2, T3, T4, T5, T6, Unit> delete() {
