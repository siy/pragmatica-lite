...
/// Implementation of HttpMethodBuilderWithBody0 for HTTP methods with no path variables and body
public record HttpMethodBuilderWithBody0Impl<B>(HttpClient client, String baseUrl, List<String> pathSegments,
                                               UrlBuilder urlBuilder, String requestContentType, Object bodyTypeInfo)
    implements HttpFunction.HttpMethodBuilderWithBody0<B> {

    // Constructor for Class<B>
    public HttpMethodBuilderWithBody0Impl(HttpClient client, String baseUrl, List<String> pathSegments,
                                         UrlBuilder urlBuilder, String requestContentType, Class<B> bodyType) {
        this(client, baseUrl, pathSegments, urlBuilder, requestContentType, (Object) bodyType);
    }

    // Constructor for TypeToken<B>
    public HttpMethodBuilderWithBody0Impl(HttpClient client, String baseUrl, List<String> pathSegments,
                                         UrlBuilder urlBuilder, String requestContentType, TypeToken<B> bodyType) {
        this(client, baseUrl, pathSegments, urlBuilder, requestContentType, (Object) bodyType);
    }

    @Override
    public <R> HttpFunction.HttpResponseContentTypeBuilderWithBody0<B, R> post(Class<R> responseType) {
        return new HttpResponseContentTypeBuilderWithBody0Impl<>(client, baseUrl, pathSegments, urlBuilder, 
