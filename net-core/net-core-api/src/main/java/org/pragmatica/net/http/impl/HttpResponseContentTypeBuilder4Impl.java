...
/// Implementation of HttpResponseContentTypeBuilder4 for four path variables
public record HttpResponseContentTypeBuilder4Impl<T1, T2, T3, T4, R>(HttpClient client, String baseUrl, List<String> pathSegments,
                                                                     List<Class<?>> paramTypes, UrlBuilder urlBuilder, 
                                                                     String requestContentType, HttpMethod httpMethod, 
                                                                     Object responseTypeInfo)
    implements HttpFunction.HttpResponseContentTypeBuilder4<T1, T2, T3, T4, R> {

    public HttpResponseContentTypeBuilder4Impl {
    ...
    public HttpResponseContentTypeBuilder4Impl(HttpClient client, String baseUrl, List<String> pathSegments,
    ...
    @Override
    public Fn4<Promise<R>, T1, T2, T3, T4> as(ContentType responseContentType) {
        return (param1, param2, param3, param4) -> {
            validateParameter(param1, 0);
            validateParameter(param2, 1);
            validateParameter(param3, 2);
            validateParameter(param4, 3);
            var url = buildUrlWithParams(List.of(param1, param2, param3, param4));
