...
class PromiseCreationExamples {
    void promiseCreationExamples() {
        ...
        var delayedPromise = Promise.<String>promise(timeSpan(2).seconds(), promise -> promise.succeed("Delayed result"));
        ...
        var fromOption3 = Option.option("Some value")
                                .async(Causes.cause("Potential null value"));
    }
