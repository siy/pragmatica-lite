...
///
///   - **Identity** - "Who am I?" (certificate + private key for presenting to peers)
///   - **Trust** - "Who do I trust?" (CA certificates for verifying peers)
///
///// Three modes are supported:
///
///   - [Server] - Accept TLS connections, optionally require client certificates
///   - [Client] - Connect to TLS servers, optionally present client certificate
///   - [Mutual] - Both sides authenticate (mTLS for service-to-service)
///
