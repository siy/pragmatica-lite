...
class NodeAddressTest {
    ...
    void creates_address_with_host_and_port() {
        var address = nodeAddress("localhost", 8080).unwrap();
    ...
    void formats_as_host_colon_port() {
        var address = nodeAddress("example.com", 443).unwrap();
    ...
    void handles_ip_addresses() {
        var address = nodeAddress("192.168.1.1", 9000).unwrap();
    ...
    void handles_ipv6_addresses() {
        var address = nodeAddress("::1", 8080).unwrap();
