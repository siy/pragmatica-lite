...
public class Authentication implements Message {
    ...
    public Authentication(boolean authenticationOk, boolean saslScramSha256, byte[] md5salt, String saslContinueData, byte[] saslAdditionalData) {
    ...
    public String saslContinueData() {
