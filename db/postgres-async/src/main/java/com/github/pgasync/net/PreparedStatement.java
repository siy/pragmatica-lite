 ...
 *     used in context of single {@link IntermediatePromise} completion at a time.
 */
public interface PreparedStatement {

    /**
     * Fetches the whole row set and returns a {@link IntermediatePromise} completed with an instance of {@link ResultSet}. This promise may be
     ...
     */
    IntermediatePromise<ResultSet> query(Object... params);
     ...
     * @param processor {@link Consumer} of single data row. Performs transformation from {@link DataRow} message to {@link Row} implementation
     *                  instance.
     * @param params    Array of query parameters values.
     *
     ...
     *     by the query.
     */
    IntermediatePromise<Integer> fetch(BiConsumer<Map<String, PgColumn>, PgColumn[]> onColumns, Consumer<Row> processor, Object... params);
