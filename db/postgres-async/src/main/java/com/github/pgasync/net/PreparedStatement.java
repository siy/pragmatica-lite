...
public interface PreparedStatement {
    ...
    /**
     * Fetches the whole row set and returns a {@link IntermediateFuture} completed with an instance of {@link ResultSet}.
     ...
     */
    IntermediateFuture<ResultSet> query(Object... params);
     ...
     */
    IntermediateFuture<Integer> fetch(BiConsumer<Map<String, PgColumn>, PgColumn[]> onColumns, Consumer<Row> processor, Object... params);
