...
public class ParametersBindingTest {
    ...
    public void shouldBindInt() {
        ...
        assertEquals(Integer.MAX_VALUE, dbr.query("SELECT INT FROM PS_TEST WHERE INT = $1", List.of(Integer.MAX_VALUE))
                                           .unwrap().index(0).getInt(0).intValue());
    }
    ...
    public void shouldBindShort() {
        ...
        assertEquals(Short.MIN_VALUE, dbr.query("SELECT SHORT FROM PS_TEST WHERE SHORT = $1", List.of(Short.MIN_VALUE))
                                         .unwrap().index(0).getLong(0).shortValue());
    }
    ...
    public void shouldBindByte() {
        ...
        assertEquals((byte) 0x41, dbr.query("SELECT BYTE FROM PS_TEST WHERE BYTE = $1", List.of(0x41))
                                     .unwrap().index(0).getByte(0).byteValue());
    }
    ...
    public void shouldBindChar() {
        ...
        assertEquals('€', dbr.query("SELECT CHAR FROM PS_TEST WHERE CHAR = $1", List.of('€'))
                             .unwrap().index(0).getChar(0).charValue());
    }
    ...
    public void shouldBindString() {
        ...
        assertEquals("val",
                     dbr.query("SELECT STRING FROM PS_TEST WHERE STRING = $1", List.of("val"))
                        .unwrap().index(0).getString(0));
    }
    ...
    public void shouldBindClob() {
        ...
        assertEquals(text, dbr.query("SELECT CLOB FROM PS_TEST WHERE CLOB = $1", List.of(text))
                              .unwrap().index(0).getString(0));
    }
    ...
    public void shouldBindTime() {
        ...
        assertEquals(time, dbr.query("SELECT TIME FROM PS_TEST WHERE TIME = $1", List.of(time))
                              .unwrap().index(0).getTime(0));
    }
    ...
    public void shouldBindTimestamp() {
        ...
        assertEquals(ts, dbr.query("SELECT TS FROM PS_TEST WHERE TS = $1", List.of(ts))
                            .unwrap().index(0).getTimestamp(0));
    }
    ...
    public void shouldBindInstant() {
        ...
        assertEquals(inst, dbr.query("SELECT TSWTZ FROM PS_TEST WHERE TSWTZ = $1", List.of(inst))
                              .unwrap().index(0).getInstant(0));
    }
    ...
    public void shouldBindDate() {
        ...
        assertEquals(date, dbr.query("SELECT TS FROM PS_TEST WHERE TS = $1", List.of(date))
                              .unwrap().index(0).getDate(0));
    }
    ...
    public void shouldBindLocalDate() {
        ...
        assertEquals(localDate, dbr.query("SELECT DATE FROM PS_TEST WHERE DATE = $1", List.of(localDate))
                                   .unwrap().index(0).getLocalDate(0));
    }
    ...
    public void shouldBindBytes() {
        ...
        assertArrayEquals(b, dbr.query("SELECT BYTEA FROM PS_TEST WHERE BYTEA = $1", List.of(b))
                                .unwrap().index(0).getBytes(0));
    }
    ...
    public void shouldBindBoolean() {
        ...
        assertTrue((Boolean) ((PgRow) dbr.query("SELECT BOOLEAN FROM PS_TEST WHERE BOOLEAN = $1", List.of(true))
                                         .unwrap().index(0)).get("boolean"));
